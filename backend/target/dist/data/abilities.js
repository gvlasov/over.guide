...
const AbilityDto_1 = __importDefault(require("./dto/AbilityDto"));
...
const data = [
    ...
    {
        id: AbilityId_1.default.NanoBoost,
        heroId: HeroId_1.default.Ana,
        name: 'Nano Boost',
        dataName: 'nano-boost',
        keyIds: [KeyId_1.default.Q],
    ...
    {
        id: AbilityId_1.default.TheViper,
        group: 'the-viper',
    ...
    {
        id: AbilityId_1.default.TheViperScoped,
        group: 'the-viper',
        heroId: HeroId_1.default.Ashe,
    ...
    {
        id: AbilityId_1.default.Dynamite,
        heroId: HeroId_1.default.Ashe,
        name: 'Dynamite',
        dataName: 'dynamite',
        keyIds: [KeyId_1.default.E],
    ...
    {
        id: AbilityId_1.default.CoachGun,
        heroId: HeroId_1.default.Ashe,
        name: 'Coach Gun',
        dataName: 'coach-gun',
        keyIds: [KeyId_1.default.Shift],
    ...
    {
        id: AbilityId_1.default.BioticLauncher,
    ...
    {
        id: AbilityId_1.default.ImmortalityField,
        heroId: HeroId_1.default.Baptiste,
    ...
    {
        id: AbilityId_1.default.AmplificationMatrix,
        heroId: HeroId_1.default.Baptiste,
    ...
    {
        id: AbilityId_1.default.ExoBoots,
        heroId: HeroId_1.default.Baptiste,
        name: 'Exo Boots',
        dataName: 'exo-boots',
        keyIds: [KeyId_1.default.Ctrl, KeyId_1.default.Space],
        description: 'By first crouching, Baptiste can jump higher.',
    },
    {
        id: AbilityId_1.default.ConfigurationRecon,
    ...
    {
        id: AbilityId_1.default.ConfigurationSentry,
        heroId: HeroId_1.default.Bastion,
    ...
    {
        id: AbilityId_1.default.Reconfigure,
        heroId: HeroId_1.default.Bastion,
        name: 'Reconfigure',
    ...
    {
        id: AbilityId_1.default.SelfRepair,
        heroId: HeroId_1.default.Bastion,
        name: 'Self-Repair',
    ...
    {
        id: AbilityId_1.default.ConfigurationTank,
        heroId: HeroId_1.default.Bastion,
    ...
    {
        id: AbilityId_1.default.RocketFlail,
        heroId: HeroId_1.default.Brigitte,
        name: 'Rocket Flail',
    ...
    {
        id: AbilityId_1.default.RepairPack,
        heroId: HeroId_1.default.Brigitte,
        name: 'Repair Pack',
    ...
    {
        id: AbilityId_1.default.WhipShot,
        heroId: HeroId_1.default.Brigitte,
        name: 'Whip Shot',
        dataName: 'whip-shot',
        keyIds: [KeyId_1.default.Shift],
    ...
    {
        id: AbilityId_1.default.BarrierShield,
        heroId: HeroId_1.default.Brigitte,
        name: 'Barrier Shield',
    ...
    {
        id: AbilityId_1.default.ShieldBash,
        heroId: HeroId_1.default.Brigitte,
        name: 'Shield Bash',
    ...
    {
        id: AbilityId_1.default.Inspire,
        heroId: HeroId_1.default.Brigitte,
        name: 'Inspire',
        dataName: 'inspire',
        keyIds: [],
    ...
    {
        id: AbilityId_1.default.FusionCannons,
    ...
    {
        id: AbilityId_1.default.LightGun,
        heroId: HeroId_1.default.Dva,
        name: 'Light Gun',
        dataName: 'light-gun',
        keyIds: [KeyId_1.default.LMB],
    ...
    {
        id: AbilityId_1.default.Boosters,
        heroId: HeroId_1.default.Dva,
        name: 'Boosters',
        dataName: 'boosters',
        keyIds: [KeyId_1.default.Shift],
    ...
    {
        id: AbilityId_1.default.DefenseMatrix,
        heroId: HeroId_1.default.Dva,
        name: 'Defense Matrix',
    ...
    {
        id: AbilityId_1.default.MicroMissiles,
        heroId: HeroId_1.default.Dva,
        name: 'Micro Missiles',
    ...
    {
        id: AbilityId_1.default.SelfDestruct,
        heroId: HeroId_1.default.Dva,
        name: 'Self-Destruct',
    ...
    {
        id: AbilityId_1.default.CallMech,
        heroId: HeroId_1.default.Dva,
        name: 'Call Mech',
        dataName: 'call-mech',
        keyIds: [KeyId_1.default.Q],
    ...
    {
        id: AbilityId_1.default.HandCannon,
        heroId: HeroId_1.default.Doomfist,
        name: 'Hand Cannon',
    ...
    {
        id: AbilityId_1.default.SeismicSlam,
        heroId: HeroId_1.default.Doomfist,
        name: 'Seismic Slam',
    ...
    {
        id: AbilityId_1.default.RisingUppercut,
        heroId: HeroId_1.default.Doomfist,
    ...
    {
        id: AbilityId_1.default.RocketPunch,
        heroId: HeroId_1.default.Doomfist,
        name: 'Rocket Punch',
    ...
    {
        id: AbilityId_1.default.MeteorStrike,
        heroId: HeroId_1.default.Doomfist,
        name: 'Meteor Strike',
    ...
    {
        id: AbilityId_1.default.TheBestDefense,
        heroId: HeroId_1.default.Doomfist,
    ...
    {
        id: AbilityId_1.default.TriShot,
        heroId: HeroId_1.default.Echo,
        name: 'Tri-Shot',
        dataName: 'tri-shot',
        keyIds: [KeyId_1.default.LMB],
    ...
    {
        id: AbilityId_1.default.StickyBombs,
        heroId: HeroId_1.default.Echo,
        name: 'Sticky Bombs',
    ...
    {
        id: AbilityId_1.default.FocusingBeam,
        heroId: HeroId_1.default.Echo,
        name: 'Focusing Beam',
    ...
    {
        id: AbilityId_1.default.Glide,
        heroId: HeroId_1.default.Echo,
        name: 'Glide',
        dataName: 'glide',
        keyIds: [KeyId_1.default.Space],
        description: 'Echo can glide while falling.',
    },
    {
        id: AbilityId_1.default.Duplicate,
        heroId: HeroId_1.default.Echo,
        name: 'Duplicate',
        dataName: 'duplicate',
        keyIds: [KeyId_1.default.Q],
    ...
    {
        id: AbilityId_1.default.CyberAgilityWallClimb,
        group: 'cyber-agility',
        heroId: HeroId_1.default.Genji,
    ...
    {
        id: AbilityId_1.default.CyberAgilityDoubleJump,
        group: 'cyber-agility',
        heroId: HeroId_1.default.Genji,
        name: 'Double Jump',
    ...
    {
        id: AbilityId_1.default.Shuriken,
        heroId: HeroId_1.default.Genji,
        name: 'Shuriken',
        dataName: 'shuriken',
        keyIds: [KeyId_1.default.LMB],
    ...
    {
        id: AbilityId_1.default.ShurikenFanOfBlades,
        heroId: HeroId_1.default.Genji,
        name: 'Shuriken Fan',
    ...
    {
        id: AbilityId_1.default.Deflect,
        heroId: HeroId_1.default.Genji,
        name: 'Deflect',
        dataName: 'deflect',
        keyIds: [KeyId_1.default.E],
    ...
    {
        id: AbilityId_1.default.SwiftStrike,
        heroId: HeroId_1.default.Genji,
        name: 'Swift Strike',
    ...
    {
        id: AbilityId_1.default.Dragonblade,
        heroId: HeroId_1.default.Genji,
        name: 'Dragonblade',
    ...
    {
        id: AbilityId_1.default.WallClimb,
        heroId: HeroId_1.default.Hanzo,
        name: 'Wall Climb',
    ...
    {
        id: AbilityId_1.default.StormBow,
        heroId: HeroId_1.default.Hanzo,
        name: 'Storm Bow',
        dataName: 'storm-bow',
        keyIds: [KeyId_1.default.LMB],
    ...
    {
        id: AbilityId_1.default.SonicArrow,
        heroId: HeroId_1.default.Hanzo,
        name: 'Sonic Arrow',
    ...
    {
        id: AbilityId_1.default.StormArrows,
        heroId: HeroId_1.default.Hanzo,
        name: 'Storm Arrows',
    ...
    {
        id: AbilityId_1.default.Dragonstrike,
        heroId: HeroId_1.default.Hanzo,
        name: 'Dragonstrike',
    ...
    {
        id: AbilityId_1.default.FragLauncher,
        heroId: HeroId_1.default.Junkrat,
        name: 'Frag Launcher',
    ...
    {
        id: AbilityId_1.default.ConcussionMine,
        heroId: HeroId_1.default.Junkrat,
    ...
    {
        id: AbilityId_1.default.SteelTrap,
        heroId: HeroId_1.default.Junkrat,
        name: 'Steel Trap',
        dataName: 'steel-trap',
        keyIds: [KeyId_1.default.Shift],
    ...
    {
        id: AbilityId_1.default.RipTire,
        heroId: HeroId_1.default.Junkrat,
        name: 'RIP-Tire',
        dataName: 'rip-tire',
        keyIds: [KeyId_1.default.Q],
    ...
    {
        id: AbilityId_1.default.TotalMayhem,
        heroId: HeroId_1.default.Junkrat,
        name: 'Total Mayhem',
    ...
    {
        id: AbilityId_1.default.SonicAmplifier,
        group: 'sonic-amplifier',
        heroId: HeroId_1.default.Lucio,
    ...
    {
        id: AbilityId_1.default.SonicAmplifierBoop,
        group: 'sonic-amplifier',
        heroId: HeroId_1.default.Lucio,
    ...
    {
        id: AbilityId_1.default.Crossfade,
        heroId: HeroId_1.default.Lucio,
        name: 'Crossfade',
        dataName: 'crossfade',
        keyIds: [KeyId_1.default.Shift],
    ...
    {
        id: AbilityId_1.default.AmpItUp,
        heroId: HeroId_1.default.Lucio,
        name: 'Amp It Up',
        dataName: 'amp-it-up',
        keyIds: [KeyId_1.default.E],
    ...
    {
        id: AbilityId_1.default.SoundBarrier,
        heroId: HeroId_1.default.Lucio,
        name: 'Sound Barrier',
    ...
    {
        id: AbilityId_1.default.WallRide,
        heroId: HeroId_1.default.Lucio,
        name: 'Wall Ride',
        dataName: 'wall-ride',
        keyIds: [KeyId_1.default.Space],
    ...
    {
        id: AbilityId_1.default.Peacekeeper,
        group: 'peacekeeper',
        heroId: HeroId_1.default.McCree,
        name: 'Peacekeeper',
    ...
    {
        id: AbilityId_1.default.PeacekeeperFanTheHammer,
        group: 'peacekeeper',
        heroId: HeroId_1.default.McCree,
        name: 'Fan the Hammer',
    ...
    {
        id: AbilityId_1.default.CombatRoll,
        heroId: HeroId_1.default.McCree,
        name: 'Combat Roll',
    ...
    {
        id: AbilityId_1.default.Flashbang,
        heroId: HeroId_1.default.McCree,
        name: 'Flashbang',
        dataName: 'flashbang',
        keyIds: [KeyId_1.default.E],
    ...
    {
        id: AbilityId_1.default.Deadeye,
        heroId: HeroId_1.default.McCree,
        name: 'Deadeye',
        dataName: 'deadeye',
        keyIds: [KeyId_1.default.Q],
    ...
    {
        id: AbilityId_1.default.EndothermicBlaster,
        group: 'endothermic-blaster',
        heroId: HeroId_1.default.Mei,
    ...
    {
        id: AbilityId_1.default.EndothermicBlasterIcicle,
        group: 'endothermic-blaster',
        heroId: HeroId_1.default.Mei,
        name: 'Icicle',
    ...
    {
        id: AbilityId_1.default.CryoFreeze,
        heroId: HeroId_1.default.Mei,
        name: 'Cryo-Freeze',
    ...
    {
        id: AbilityId_1.default.IceWall,
        heroId: HeroId_1.default.Mei,
        name: 'Ice Wall',
        dataName: 'ice-wall',
        keyIds: [KeyId_1.default.E],
    ...
    {
        id: AbilityId_1.default.Blizzard,
        heroId: HeroId_1.default.Mei,
        name: 'Blizzard',
        dataName: 'blizzard',
        keyIds: [KeyId_1.default.Q],
    ...
    {
        id: AbilityId_1.default.CaduceusStaffHeal,
        group: 'caduceus-staff-heal',
        heroId: HeroId_1.default.Mercy,
        name: 'Caduceus Staff (Heal)',
        dataName: 'caduceus-staff-heal',
        keyIds: [KeyId_1.default.One, KeyId_1.default.LMB],
    ...
    {
        id: AbilityId_1.default.Resurrect,
        heroId: HeroId_1.default.Mercy,
        name: 'Resurrect',
        dataName: 'resurrect',
        keyIds: [KeyId_1.default.E],
    ...
    {
        id: AbilityId_1.default.AngelicDescent,
        heroId: HeroId_1.default.Mercy,
    ...
    {
        id: AbilityId_1.default.Valkyrie,
        heroId: HeroId_1.default.Mercy,
        name: 'Valkyrie',
        dataName: 'valkyrie',
        keyIds: [KeyId_1.default.Q],
    ...
    {
        id: AbilityId_1.default.Regeneration,
        heroId: HeroId_1.default.Mercy,
        name: 'Regeneration',
    ...
    {
        id: AbilityId_1.default.BioticGraspHeal,
        group: 'biotic-grasp',
        heroId: HeroId_1.default.Moira,
    ...
    {
        id: AbilityId_1.default.BioticGraspDamage,
    ...
    {
        id: AbilityId_1.default.HealingOrb,
        group: 'biotic-orb',
        heroId: HeroId_1.default.Moira,
        name: 'Healing Orb',
        dataName: 'biotic-orb-heal',
        keyIds: [KeyId_1.default.E, KeyId_1.default.LMB],
    ...
    {
        id: AbilityId_1.default.DamageOrb,
        group: 'biotic-orb',
        heroId: HeroId_1.default.Moira,
        name: 'Damage Orb',
        dataName: 'biotic-orb-damage',
        keyIds: [KeyId_1.default.E, KeyId_1.default.RMB],
        description: 'Moira launches a rebounding biotic sphere; she can choose between a regeneration effect that heals the teammates it passes through, or a decay effect that deals damage to enemies.',
    },
    {
        id: AbilityId_1.default.Fade,
        heroId: HeroId_1.default.Moira,
        name: 'Fade',
        dataName: 'fade',
        keyIds: [KeyId_1.default.Shift],
    ...
    {
        id: AbilityId_1.default.Coalescense,
        heroId: HeroId_1.default.Moira,
        name: 'Coalescense',
    ...
    {
        id: AbilityId_1.default.FusionDriver,
        heroId: HeroId_1.default.Orisa,
        name: 'Fusion Driver',
    ...
    {
        id: AbilityId_1.default.Fortify,
        heroId: HeroId_1.default.Orisa,
        name: 'Fortify',
        dataName: 'fortify',
        keyIds: [KeyId_1.default.Shift],
    ...
    {
        id: AbilityId_1.default.ProtectiveBarrier,
        heroId: HeroId_1.default.Orisa,
    ...
    {
        id: AbilityId_1.default.Supercharger,
        heroId: HeroId_1.default.Orisa,
        name: 'Supercharger',
    ...
    {
        id: AbilityId_1.default.HoverJets,
        heroId: HeroId_1.default.Pharah,
        name: 'Hover Jets',
        dataName: 'hover-jets',
        keyIds: [KeyId_1.default.Space],
    ...
    {
        id: AbilityId_1.default.RocketLauncher,
        heroId: HeroId_1.default.Pharah,
    ...
    {
        id: AbilityId_1.default.JumpJet,
        heroId: HeroId_1.default.Pharah,
        name: 'Jump Jet',
        dataName: 'jump-jet',
        keyIds: [KeyId_1.default.Shift],
    ...
    {
        id: AbilityId_1.default.ConcussiveBlast,
        heroId: HeroId_1.default.Pharah,
    ...
    {
        id: AbilityId_1.default.Barrage,
        heroId: HeroId_1.default.Pharah,
        name: 'Barrage',
        dataName: 'barrage',
        keyIds: [KeyId_1.default.Q],
    ...
    {
        id: AbilityId_1.default.HellfireShotguns,
        heroId: HeroId_1.default.Reaper,
    ...
    {
        id: AbilityId_1.default.WraithForm,
        heroId: HeroId_1.default.Reaper,
        name: 'Wraith Form',
    ...
    {
        id: AbilityId_1.default.ShadowStep,
        heroId: HeroId_1.default.Reaper,
        name: 'Shadow Step',
    ...
    {
        id: AbilityId_1.default.DeathBlossom,
        heroId: HeroId_1.default.Reaper,
        name: 'Death Blossom',
    ...
    {
        id: AbilityId_1.default.TheReaping,
        heroId: HeroId_1.default.Reaper,
        name: 'The Reaping',
    ...
    {
        id: AbilityId_1.default.RocketHammer,
        heroId: HeroId_1.default.Reinhardt,
        name: 'Rocket Hammer',
    ...
    {
        id: AbilityId_1.default.BarrierField,
        heroId: HeroId_1.default.Reinhardt,
        name: 'Barrier Field',
    ...
    {
        id: AbilityId_1.default.FireStrike,
        heroId: HeroId_1.default.Reinhardt,
        name: 'Fire Strike',
    ...
    {
        id: AbilityId_1.default.Earthshatter,
        heroId: HeroId_1.default.Reinhardt,
        name: 'Earthshatter',
    ...
    {
        id: AbilityId_1.default.Steadfast,
        heroId: HeroId_1.default.Reinhardt,
        name: 'Steadfast',
        dataName: 'steadfast',
        keyIds: [],
    ...
    {
        id: AbilityId_1.default.ScrapGun,
        group: 'scrap-gun',
        heroId: HeroId_1.default.Roadhog,
        name: 'Scrap Gun',
        dataName: 'scrap-gun',
        keyIds: [KeyId_1.default.LMB],
    ...
    {
        id: AbilityId_1.default.ScrapGunAltFire,
        group: 'scrap-gun',
        heroId: HeroId_1.default.Roadhog,
    ...
    {
        id: AbilityId_1.default.TakeABreather,
        heroId: HeroId_1.default.Roadhog,
    ...
    {
        id: AbilityId_1.default.ChainHook,
        heroId: HeroId_1.default.Roadhog,
        name: 'Chain Hook',
        dataName: 'chain-hook',
        keyIds: [KeyId_1.default.Shift],
    ...
    {
        id: AbilityId_1.default.WholeHog,
        heroId: HeroId_1.default.Roadhog,
        name: 'Whole Hog',
        dataName: 'whole-hog',
        keyIds: [KeyId_1.default.Q],
    ...
    {
        id: AbilityId_1.default.Hyperspheres,
        heroId: HeroId_1.default.Sigma,
        name: 'Hyperspheres',
    ...
    {
        id: AbilityId_1.default.ExperimentalBarrier,
        heroId: HeroId_1.default.Sigma,
    ...
    {
        id: AbilityId_1.default.KineticGrasp,
        heroId: HeroId_1.default.Sigma,
        name: 'Kinetic Grasp',
    ...
    {
        id: AbilityId_1.default.Accretion,
        heroId: HeroId_1.default.Sigma,
        name: 'Accretion',
        dataName: 'accretion',
        keyIds: [KeyId_1.default.E],
    ...
    {
        id: AbilityId_1.default.GraviticFlux,
        heroId: HeroId_1.default.Sigma,
        name: 'Gravitic Flux',
    ...
    {
        id: AbilityId_1.default.HeavyPulseRifle,
        heroId: HeroId_1.default.Soldier,
    ...
    {
        id: AbilityId_1.default.HelixRockets,
        heroId: HeroId_1.default.Soldier,
        name: 'Helix Rockets',
    ...
    {
        id: AbilityId_1.default.BioticField,
        heroId: HeroId_1.default.Soldier,
        name: 'Biotic Field',
    ...
    {
        id: AbilityId_1.default.TacticalVisor,
        heroId: HeroId_1.default.Soldier,
        name: 'Tactical Visor',
    ...
    {
        id: AbilityId_1.default.MachinePistol,
        heroId: HeroId_1.default.Sombra,
        name: 'Machine Pistol',
    ...
    {
        id: AbilityId_1.default.Stealth,
        heroId: HeroId_1.default.Sombra,
        name: 'Stealth',
        dataName: 'stealth',
        keyIds: [KeyId_1.default.Shift],
    ...
    {
        id: AbilityId_1.default.Translocator,
        heroId: HeroId_1.default.Sombra,
        name: 'Translocator',
    ...
    {
        id: AbilityId_1.default.Opportunist,
        heroId: HeroId_1.default.Sombra,
        name: 'Opportunist',
    ...
    {
        id: AbilityId_1.default.PhotonProjector,
        group: 'photon-projector',
        heroId: HeroId_1.default.Symmetra,
    ...
    {
        id: AbilityId_1.default.PhotonProjectorAltFire,
        group: 'photon-projector',
        heroId: HeroId_1.default.Symmetra,
    ...
    {
        id: AbilityId_1.default.SentryTurret,
        heroId: HeroId_1.default.Symmetra,
        name: 'Sentry Turret',
    ...
    {
        id: AbilityId_1.default.Teleporter,
        heroId: HeroId_1.default.Symmetra,
        name: 'Teleporter',
        dataName: 'teleporter',
        keyIds: [KeyId_1.default.E],
    ...
    {
        id: AbilityId_1.default.PhotonBarrier,
        heroId: HeroId_1.default.Symmetra,
        name: 'Photon Barrier',
    ...
    {
        id: AbilityId_1.default.RivetGun,
        group: 'rivet-gun',
        heroId: HeroId_1.default.Torbjorn,
        name: 'Rivet Gun',
        dataName: 'rivet-gun',
        keyIds: [KeyId_1.default.LMB],
    ...
    {
        id: AbilityId_1.default.RivetGunAltFire,
        group: 'rivet-gun',
        heroId: HeroId_1.default.Torbjorn,
    ...
    {
        id: AbilityId_1.default.ForgeHamer,
        heroId: HeroId_1.default.Torbjorn,
        name: 'Forge Hammer',
    ...
    {
        id: AbilityId_1.default.DeployTurret,
        heroId: HeroId_1.default.Torbjorn,
        name: 'Deploy Turret',
    ...
    {
        id: AbilityId_1.default.Overload,
        heroId: HeroId_1.default.Torbjorn,
        name: 'Overload',
        dataName: 'overload',
        keyIds: [KeyId_1.default.E],
    ...
    {
        id: AbilityId_1.default.MoltenCore,
        heroId: HeroId_1.default.Torbjorn,
        name: 'Molten Core',
    ...
    {
        id: AbilityId_1.default.PulsePistols,
        heroId: HeroId_1.default.Tracer,
        name: 'Pulse Pistols',
    ...
    {
        id: AbilityId_1.default.PulseBomb,
        heroId: HeroId_1.default.Tracer,
        name: 'Pulse Bomb',
        dataName: 'pulse-bomb',
        keyIds: [KeyId_1.default.Q],
    ...
    {
        id: AbilityId_1.default.WidowsKissScoped,
        group: 'widows-kiss',
        heroId: HeroId_1.default.Widowmaker,
    ...
    {
        id: AbilityId_1.default.WidowsKissUnscoped,
        group: 'widows-kiss',
        heroId: HeroId_1.default.Widowmaker,
    ...
    {
        id: AbilityId_1.default.GrapplingHook,
        heroId: HeroId_1.default.Widowmaker,
        name: 'Grappling Hook',
    ...
    {
        id: AbilityId_1.default.VenomMine,
        heroId: HeroId_1.default.Widowmaker,
        name: 'Venom Mine',
        dataName: 'venom-mine',
        keyIds: [KeyId_1.default.E],
    ...
    {
        id: AbilityId_1.default.InfraSight,
        heroId: HeroId_1.default.Widowmaker,
        name: 'Infra-Sight',
    ...
    {
        id: AbilityId_1.default.TeslaCannon,
        heroId: HeroId_1.default.Winston,
        name: 'Tesla Cannon',
    ...
    {
        id: AbilityId_1.default.JumpPack,
        heroId: HeroId_1.default.Winston,
        name: 'Jump Pack',
        dataName: 'jump-pack',
        keyIds: [KeyId_1.default.Shift],
    ...
    {
        id: AbilityId_1.default.BarrierProjector,
        heroId: HeroId_1.default.Winston,
    ...
    {
        id: AbilityId_1.default.PrimalRage,
        heroId: HeroId_1.default.Winston,
        name: 'Primal Rage',
    ...
    {
        id: AbilityId_1.default.QuadCannons,
        heroId: HeroId_1.default.WreckingBall,
        name: 'Quad Cannons',
    ...
    {
        id: AbilityId_1.default.GrapplingClaw,
        heroId: HeroId_1.default.WreckingBall,
        name: 'Grappling Claw',
    ...
    {
        id: AbilityId_1.default.AdaptiveShield,
        heroId: HeroId_1.default.WreckingBall,
    ...
    {
        id: AbilityId_1.default.ParticleCannon,
        group: 'particle-cannon',
        heroId: HeroId_1.default.Zarya,
    ...
    {
        id: AbilityId_1.default.ParticleCannonAltFire,
        group: 'particle-cannon',
        heroId: HeroId_1.default.Zarya,
    ...
    {
        id: AbilityId_1.default.ParticleBarrier,
        heroId: HeroId_1.default.Zarya,
    ...
    {
        id: AbilityId_1.default.ProjectedBarrier,
        heroId: HeroId_1.default.Zarya,
    ...
    {
        id: AbilityId_1.default.GravitonSurge,
        heroId: HeroId_1.default.Zarya,
        name: 'Graviton Surge',
    ...
    {
        id: AbilityId_1.default.OrbOfDestruction,
        group: 'orb-of-destruction',
        heroId: HeroId_1.default.Zenyatta,
    ...
    {
        id: AbilityId_1.default.OrbOfDestructionVolley,
        group: 'orb-of-destruction',
        heroId: HeroId_1.default.Zenyatta,
    ...
    {
        id: AbilityId_1.default.OrbOfHarmony,
        heroId: HeroId_1.default.Zenyatta,
        name: 'Orb of Harmony',
    ...
    {
        id: AbilityId_1.default.OrbOfDiscord,
        heroId: HeroId_1.default.Zenyatta,
        name: 'Orb of Discord',
    ...
    {
        id: AbilityId_1.default.Transcendence,
        heroId: HeroId_1.default.Zenyatta,
        name: 'Transcendence',
