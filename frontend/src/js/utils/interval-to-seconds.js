function extractLeftComponent(interval, componentLength) {
...
/**
 * @param {string} interval hh:mm:ss.MMM or mm:ss.MMM
 * @return {number}
 */
export default function intervalToSeconds(interval) {
    let hours;
